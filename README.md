...
## V40 — Sửa lỗi MP3 không phát

Player dùng tên chuẩn:

`music/anh-tu.mp3`

Player tự thử lần lượt:

1. `music/anh-tu.mp3`
2. `music/anh-tu-demo.mp3`
3. `music/anh-tu.wav`
4. `music/anh-tu-demo.wav`

Khi không tìm thấy hoặc file bị lỗi, player hiển thị thông báo trực tiếp.

### Lưu ý GitHub Pages

Tên file và thư mục phân biệt chữ hoa/chữ thường:

- Đúng: `music/anh-tu.mp3`
- Sai: `Music/Anh-Tu.MP3`
- Sai: `anh tu.mp3`

File MP3 nên là MPEG Layer III, bitrate 128–320 kbps.


## V41 — Player bài hát cố định

Đã loại bỏ chức năng cho người truy cập chọn MP3/WAV từ thiết bị.

Player chỉ phát bài hát được cài sẵn tại:

`music/anh-tu.mp3`

Người truy cập chỉ có thể:
...
Để đổi bài hát, quản trị viên chỉ cần ghi đè file
`music/anh-tu.mp3`.


## V42 — Danh sách nhiều bài hát cố định

Đã thêm danh sách 4 bài ngay dưới audio player.

Khi người nghe chọn một bài:
- Player đổi nguồn MP3.
- Đổi tên bài hát.
- Đổi tên nghệ sĩ/phiên bản.
- Đổi ảnh giữa đĩa than.
- Đánh dấu bài đang chọn.
- Phát bài vừa chọn.

Có thêm:
- Nút bài trước.
- Nút bài tiếp theo.
- Tự chuyển sang bài tiếp theo khi bài hiện tại kết thúc.

Các file MP3:

- `music/chi-con-tinh-yeu.mp3`
- `music/so-yeu.mp3`
- `music/acoustic-session.mp3`
- `music/live-performance.mp3`

Người truy cập không thể thêm bài hát từ thiết bị.


## V43 — Sửa logo Contact & Booking

Đã thay icon phần Contact & Booking sang bộ logo đúng hơn cho:
- Điện thoại
- Facebook
- YouTube
- Email

Các icon được sửa trong `index.html` và đồng bộ sang `css/style.css`.


## V44 — Nút phát video chuyên nghiệp

Đã thiết kế lại toàn bộ nút phát video ở:
- Section Visual Video
- Section Tuyển tập phát hành

Cải tiến:
- Nút dạng nổi 3D chuyên nghiệp
- Có icon và chữ rõ ràng
- Hiển thị trạng thái:
  - Phát video
  - Dừng video
- Khi mở popup video, nút đổi sang trạng thái active
- Khi đóng popup, nút trở lại trạng thái phát video


## V45 — Contact logos + compact video buttons + audio fix
...
Logo là file ảnh riêng:
- `images/contact-phone.svg`
- `images/contact-zalo.svg`
- `images/contact-facebook.svg`
- `images/contact-youtube.svg`
- `images/contact-gmail.svg`

### Nút phát video
- Chỉ còn biểu tượng Play/Pause.
- Nút tròn nhỏ, hiệu ứng nổi nhẹ.
- Khi popup mở, icon đổi sang Pause.
- Khi popup đóng, icon trở lại Play.

### Audio playlist
Logic phát nhạc đã được viết lại:
- Nhấn vào bài sẽ đổi nguồn và gọi `audio.play()` ngay trong lần chạm.
- Tương thích tốt hơn với Safari/iPhone.
- Có Play/Pause, bài trước, bài sau, tua và âm lượng.
- Tự chuyển bài khi kết thúc.

Bốn file MP3 mặc định là âm thanh demo có tiếng để kiểm tra:
- `music/chi-con-tinh-yeu.mp3`
- `music/so-yeu.mp3`
- `music/acoustic-session.mp3`
- `music/live-performance.mp3`

Ghi đè các file này bằng bài thật và giữ nguyên tên.


## V46 — Sửa lỗi audio runtime và nền menu

### Lỗi audio đã sửa

Nguyên nhân ở V45:
- Bộ điều khiển audio gọi `$` và `$$` bên ngoài phạm vi khai báo.
- Trình duyệt phát sinh lỗi JavaScript trước khi gắn sự kiện chọn bài.
- Kết quả: thời lượng `00:00`, nút Play và danh sách bài không hoạt động.

V46:
- Player dùng bộ chọn phần tử riêng trong một IIFE độc lập.
- Mỗi lần chọn bài sẽ đổi đường dẫn và gọi `audio.play()` trực tiếp trong thao tác chạm.
- Đường dẫn được tạo dựa trên `document.baseURI`, phù hợp GitHub Pages.
- Có cache-busting `v=46`.
- Chọn bài, Play/Pause, bài trước, bài sau, tua và âm lượng đều được gắn lại.

### Nền menu

- Nút hamburger: đỏ rượu vang đặc.
- Bảng menu mobile: xanh đen đặc.
- Mỗi liên kết menu có nền card màu đặc.
- Không dùng gradient cho nền menu.
